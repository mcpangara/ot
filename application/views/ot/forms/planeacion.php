		...
		<table class="mytabla largWidth">
			...
			<tbody>
				...
				<tr ng-repeat="act in tr.actividades | orderBy: 'codigo'">
					...
					<td>{{ act.unidad }}</td>
					<td> <input type="number" style="border: 1px solid #E65100; width:7ex" min="0" ng-model="act.cantidad" ng-init="act.cantidad = strtonum(act.cantidad)" style="width:8ex" ng-change="calcularSubtotales()"> </td>
					<td> <input type="number" style="border: 1px solid #E65100; width:10ex" min="0" ng-model="act.duracion" ng-init="act.duracion = strtonum(act.duracion)" style="width:10ex" ng-change="calcularSubtotales()"> </td>
				...
				<tr ng-repeat="per in tr.personal | orderBy: 'codigo'">
					...
					<td>{{ per.unidad }}</td>
					<td><input type="number" style="border: 1px solid #E65100; width:7ex" min="0" ng-model="per.cantidad" ng-init="per.cantidad = strtonum(per.cantidad)" style="width:7ex" ng-change="calcularSubtotales()"> </td>
					<td><input type="number" style="border: 1px solid #E65100; width:10ex" min="0" ng-model="per.duracion" ng-init="per.duracion = strtonum(per.duracion)" style="width:10ex" ng-change="calcularSubtotales()"> </td>
				...
				<tr ng-repeat="eq in tr.equipos | orderBy: 'codigo'">
					...
					<td>{{ eq.unidad }}</td>
					<td> <input type="number" style="border: 1px solid #E65100; width:7ex" min="0" ng-model="eq.cantidad" ng-init="eq.cantidad = strtonum(eq.cantidad)" ng-change="calcularSubtotales()"> </td>
					<td> <input type="number" style="border: 1px solid #E65100; width:10ex" min="0" ng-model="eq.duracion" ng-init="eq.duracion = strtonum(eq.duracion)"  ng-change="calcularSubtotales()"> </td>
